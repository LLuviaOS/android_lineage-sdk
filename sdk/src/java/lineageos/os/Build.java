...
public class Build {
    ...
    public static final String LLUVIAOS_VERSION = getString("ro.lluvia.version");

    /** A build ID string meant for displaying to the user */
    public static final String LLUVIAOS_DISPLAY_VERSION = getString("ro.lluvia.display.version");
